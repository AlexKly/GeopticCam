...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1 -new_name clk_wiz -ip [get_ips clk_wiz]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top clk_wiz -part xc7a35tftg256-2 -mode out_of_context
...
if { [catch {
  file copy -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1/clk_wiz.dcp D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1/clk_wiz_stub.v D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1/clk_wiz_stub.vhdl D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1/clk_wiz_sim_netlist.v D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.runs/clk_wiz_synth_1/clk_wiz_sim_netlist.vhdl D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Library_Projects_FPGA/GeopticCam/GeopticCam.ip_user_files/ip/clk_wiz]} {
  catch { 
    file copy -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.v D:/Library_Projects_FPGA/GeopticCam/GeopticCam.ip_user_files/ip/clk_wiz
  }
}

if {[file isdir D:/Library_Projects_FPGA/GeopticCam/GeopticCam.ip_user_files/ip/clk_wiz]} {
  catch { 
    file copy -force D:/Library_Projects_FPGA/GeopticCam/GeopticCam.srcs/sources_1/ip/clk_wiz/clk_wiz_stub.vhdl D:/Library_Projects_FPGA/GeopticCam/GeopticCam.ip_user_files/ip/clk_wiz
  }
}
